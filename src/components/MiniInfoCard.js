        ...
        <div className="bg-white dark:bg-[#232a31] dark:text-gray-100 p-4 rounded shadow-md">
            ...
            <p>
              ...
              <span className="inline-flex items-center ml-1">
                <Info size={14} className="text-gray-300 hover:text-white cursor-help" data-tooltip-id="yield-tooltip"/>
              </span>
            </p>
            <p>
            ...
            <Tooltip id="yield-tooltip" place="bottom" effect="solid"   className="!max-w-[240px] text-xs text-white bg-gray-800 rounded px-3 py-2">
